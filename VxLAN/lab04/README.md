...
- На Spine настроен шаблон с автоматическим установлением BGP-соседства с Leaf (пассивное ожидание). На Leaf настроен шаблон с активным установлением BGP-соседства со Spine.
- Leaf анонсирует маршрутную информацию только о Loopback 0. Spine ничего не анонсиркет.
